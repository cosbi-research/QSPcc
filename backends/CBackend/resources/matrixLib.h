...
extern void viSinhImpl( int n, int *input, double *output);
extern void vdSinhImpl( int n, double *input, double *output);
extern void siSinhImpl( int n, islice input, double *output);
extern void sdSinhImpl( int n, dslice input, double *output);
extern void viCoshImpl( int n, int *input, double *output);
extern void vdCoshImpl( int n, double *input, double *output);
extern void siCoshImpl( int n, islice input, double *output);
extern void sdCoshImpl( int n, dslice input, double *output);
extern void viTanhImpl( int n, int *input, double *output);
extern void vdTanhImpl( int n, double *input, double *output);
extern void siTanhImpl( int n, islice input, double *output);
extern void sdTanhImpl( int n, dslice input, double *output);
